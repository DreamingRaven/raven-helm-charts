...
helm install piper oci://registry.gitlab.com/georgeraven/raven-helm-charts/piper --version 0.2.0
```
...
- name: piper
  ...
  # condition: piper.enabled # optional for more advanced use-cases
```
