...
![Version: 0.7.2](https://img.shields.io/badge/Version-0.7.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.63.3](https://img.shields.io/badge/AppVersion-v2.63.3-informational?style=flat-square)
...
helm install filebrowser oci://registry.gitlab.com/georgeraven/raven-helm-charts/filebrowser --version 0.7.2
```
...
| image.tag | string | `"v2.63.3@sha256:289c5dd677c56662440f26eeb44266ed9746fe563d2e9100f546bff558534d70"` |  |
