...
![Version: 0.7.3](https://img.shields.io/badge/Version-0.7.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.63.3](https://img.shields.io/badge/AppVersion-v2.63.3-informational?style=flat-square)
...
helm install filebrowser oci://registry.gitlab.com/georgeraven/raven-helm-charts/filebrowser --version 0.7.3
```
...
| image.tag | string | `"v2.63.23@sha256:a469ea076d4a1b4b1d86a41d130f2f536cd9da996a2b1fb39c0d7635f9d89b9a"` |  |
