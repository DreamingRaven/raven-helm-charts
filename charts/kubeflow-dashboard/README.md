...
```console
helm install kubeflow-dashboard oci://registry.gitlab.com/georgeraven/raven-helm-charts/kubeflow-dashboard
```
...
helm install kubeflow-dashboard oci://registry.gitlab.com/georgeraven/raven-helm-charts/kubeflow-dashboard --version 0.1.0
```
