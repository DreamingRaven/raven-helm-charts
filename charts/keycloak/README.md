...
helm install keycloak oci://registry.gitlab.com/georgeraven/raven-helm-charts/keycloak --version 0.1.0
```
...
| oci://registry.gitlab.com/georgeraven/raven-helm-charts | postgres | 0.1.0 |
