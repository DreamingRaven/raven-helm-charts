...
![Version: 0.9.0](https://img.shields.io/badge/Version-0.9.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2026.02.19](https://img.shields.io/badge/AppVersion-2026.02.19-informational?style=flat-square)
...
helm install metube oci://registry.gitlab.com/georgeraven/raven-helm-charts/metube --version 0.9.0
```
...
| metube.image.tag | string | `"2026.09.20@sha256:36ebbfdcdfe6ee286e2b231d91c78759bb629cd283c6f75b75e1657fda2134f4"` |  |
