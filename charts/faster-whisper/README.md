...
To install the chart with the release name `faster-whisper`, run the following commands.
...
```console
helm install faster-whisper oci://registry.gitlab.com/georgeraven/raven-helm-charts/faster-whisper
```
...
$ helm install faster-whisper raven/faster-whisper
```
...
| env[3].name | string | `"WHISPER_MODEL"` |  |
| env[3].value | string | `"tiny-int8"` |  |
| env[4].name | string | `"WHISPER_BEAM"` |  |
| env[4].value | string | `"1"` |  |
| env[5].name | string | `"WHISPER_LANG"` |  |
| env[5].value | string | `"en"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.registry | string | `"ghcr.io"` |  |
| image.repository | string | `"linuxserver/faster-whisper"` |  |
| image.tag | string | `"2.4.0"` |  |
| imagePullSecrets | list | `[]` |  |
| ingress.annotations | object | `{}` |  |
| ingress.className | string | `""` |  |
| ingress.enabled | bool | `false` |  |
| ingress.hosts[0].host | string | `"faster-whisper.org.example"` |  |
...
| ports[0].containerPort | int | `10300` |  |
| ports[0].name | string | `"wyoming"` |  |
| ports[0].protocol | string | `"TCP"` |  |
| ports[0].servicePort | int | `10300` |  |
