...
helm install jellymeta oci://registry.gitlab.com/georgeraven/raven-helm-charts/jellymeta --version 0.9.0
```
...
|------------|------|---------|
| https://gitlab.com/api/v4/projects/55284972/packages/helm/stable | filebrowser | 0.7.2 |
| https://gitlab.com/api/v4/projects/55284972/packages/helm/stable | jellyfin | 0.9.0 |
| https://gitlab.com/api/v4/projects/55284972/packages/helm/stable | metube | 0.7.1 |
